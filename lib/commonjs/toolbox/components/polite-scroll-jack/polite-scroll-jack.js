    ...
    PoliteScrollJack.prototype.getNextActiveSlide_ = function () {
        ...
        if (activeElement === currentActiveSlide) {
            if (is_filling_visible_height_if_unstuck_1.isFillingVisibleHeightIfUnstuck(activeElement)) {
                ...
                var totalVisibleHeight = this.carousel_.getSlides().reduce(function (result, slide) { return result + get_visible_height_if_unstuck_1.getVisibleHeightIfUnstuck(slide); }, 0);
