...
var ContainerConstraint = (function (_super) {
    ...
    function ContainerConstraint(container) {
        ...
        _this.constrainingDimensions_ =
            dimensions_1.Dimensions.getForElement(container);
        _this.container_ = container;
        return _this;
    }
    ContainerConstraint.prototype.constrainDelta = function (draggable, delta) {
        var draggableDimensions = dimensions_1.Dimensions.getForElement(draggable.getElement())
            .getDimensions();
