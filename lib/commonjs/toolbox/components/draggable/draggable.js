...
var Draggable = (function () {
    ...
    Draggable.prototype.initInteraction_ = function () {
        ...
        var endInteractionEventTypes = [
            event_type_1.EventType.CONTEXTMENU,
            event_type_1.EventType.DRAGSTART,
            event_type_1.EventType.CURSOR_UP,
        ];
        endInteractionEventTypes
            .forEach(function (eventType) {
            add_dom_event_listener_1.addDomEventListener(window, eventType, function () { return _this.endInteraction_(); });
        });
    ...
    Draggable.prototype.endInteraction_ = function () {
        ...
        render_loop_1.renderLoop.measure(function () {
            event_handler_1.eventHandler
                .dispatchEvent(new drag_end_1.DragEnd(_this, _this.getDelta_(), cursor_1.cursor.getClient().getLastFrameVelocity()));
        });
    };
