...
var PhysicallyDraggable = (function () {
    function PhysicallyDraggable(target, _a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.draggableConstraints, draggableConstraints = _c === void 0 ? defaultPhysicallyDraggableConfig.draggableConstraints : _c, _d = _b.physical2d, physical2d = _d === void 0 ? defaultPhysicallyDraggableConfig.physical2d : _d;
        ...
        this.draggable_ =
            new draggable_1.Draggable(target, { constraints: draggableConstraints });
        this.init_();
    }
