...
var SmoothScrollService = (function () {
    ...
    SmoothScrollService.prototype.scrollToX = function (x) {
        this.xTransition_ =
            new SmoothScrollTransition(new numeric_range_1.NumericRange(this.element_.scrollLeft, Math.max(0, x)), this.generateTimeline_());
    };
    SmoothScrollService.prototype.scrollToY = function (y) {
        this.yTransition_ =
            new SmoothScrollTransition(new numeric_range_1.NumericRange(this.element_.scrollTop, Math.max(0, y)), this.generateTimeline_());
    };
