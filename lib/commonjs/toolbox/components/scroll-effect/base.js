...
var ScrollEffectRunValue = (function () {
    ...
    ScrollEffectRunValue.prototype.getRunRangeAsPercent = function () {
        return new numeric_range_1.NumericRange(this.lastRunDistanceAsPercent, this.distanceAsPercent);
    };
    ScrollEffectRunValue.prototype.getRunRange = function () {
        return new numeric_range_1.NumericRange(this.lastRunDistance, this.distance);
    };
