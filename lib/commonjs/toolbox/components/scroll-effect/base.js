...
var ScrollEffect = (function () {
    ...
    ScrollEffect.prototype.init_ = function () {
        ...
        render_loop_1.renderLoop.scrollMeasure(function () { return _this.runEffect_(); });
    };
    ScrollEffect.prototype.runEffect_ = function () {
        ...
        render_loop_1.renderLoop.scrollMeasure(function () {
            render_loop_1.renderLoop.scrollCleanup(function () { return _this.runEffect_(); });
            var distance = _this.getRunDistance_();
            if (distance === _this.lastRunDistance_) {
                return;
            }
            _this.lastRunDistance_ = distance;
            var percent = _this.distanceRange_.getValueAsPercent(distance);
            _this.effects_
