...
var ScrollEffectRunValue = (function () {
    function ScrollEffectRunValue(distance, distanceAsPercent, lastRunValue) {
        ...
        this.clientHeight = root_element_1.ROOT_ELEMENT.clientHeight;
        this.clientWidth = root_element_1.ROOT_ELEMENT.clientWidth;
...
var ScrollEffect = (function () {
    function ScrollEffect(target, _a) {
        ...
        if (target === null) {
            service_1.ErrorService.throw('ScrollEffect requires a valid HTMLElement as a target');
        }
