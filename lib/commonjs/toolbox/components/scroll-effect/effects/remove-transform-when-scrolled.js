...
var RemoveTransformWhenScrolled = (function () {
    ...
    RemoveTransformWhenScrolled.prototype.run = function (target, distance, distanceAsPercent) {
        if (distance > this.minimumScrollDistance_) {
            render_loop_1.renderLoop.scrollMutate(function () { return set_style_1.setStyle(target, 'transform', 'none'); });
        }
        else {
            render_loop_1.renderLoop.scrollMutate(function () { return set_style_1.setStyle(target, 'transform', ''); });
        }
    };
