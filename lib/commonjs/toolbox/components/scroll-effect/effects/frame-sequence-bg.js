...
exports.FrameSequenceBg = void 0;
...
var FrameSequenceBg = (function () {
    ...
    FrameSequenceBg.generateFrameLoadOrderLoop_ = function (remaining) {
        ...
        return __spreadArrays([
            remaining[middle]
        ], flatten_1.flatten(zip_1.zip(this.generateFrameLoadOrderLoop_(left), this.generateFrameLoadOrderLoop_(right))));
    };
    ...
    FrameSequenceBg.prototype.replaceFramesInPlace = function (frames) {
        ...
        if (frames.length !== this.imageUrlsInOrder_.length) {
            service_1.ErrorService.throw('Can only replaceFramesInPlace if frame count is constant');
        }
