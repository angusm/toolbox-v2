...
var KeyframePair = (function () {
    ...
    KeyframePair.createGetValueRangeFunction_ = function (keyframeA, keyframeB) {
        if (keyframeA.isDynamicValue() || keyframeB.isDynamicValue()) {
            return function () {
                return new measurable_range_1.MeasurableRange(keyframeA.getValue(keyframeB), keyframeB.getValue(keyframeA));
            };
        }
        else {
            var measurableRange_1 = new measurable_range_1.MeasurableRange(keyframeA.getValue(keyframeB), keyframeB.getValue(keyframeA));
