...
var KeyframePair = (function () {
    ...
    KeyframePair.prototype.getValueRange_ = function () {
        return new measurable_range_1.MeasurableRange(this.keyframeA_.getValue(this.keyframeB_), this.keyframeB_.getValue(this.keyframeA_));
    };
