...
var generate_tweenable_filter_class_1 = require("./generate-tweenable-filter-class");
...
var Keyframe = (function () {
    ...
    Keyframe.prototype.getFilterValue_ = function (adjacentKeyframe) {
        ...
        var sortedFilters = sortedKeyframes
            .map(function (keyframe) { return filter_1.Filter.fromStyleString(keyframe.getRawValue()); });
        var primaryFilter = filter_1.Filter.fromStyleString(this.getRawValue());
        var filterClassesInOrder = Keyframe.getFilterClassesInOrder_(sortedFilters);
        var TweenableFilterClass = generate_tweenable_filter_class_1.generateTweenableFilterClass(filterClassesInOrder);
