...
var VideoScrubByPlay = (function () {
    ...
    VideoScrubByPlay.prototype.getReversePlayableTime_ = function (video) {
        return new numeric_range_1.NumericRange(Math.max(0, video.duration - this.playableTime_.max), Math.min(video.duration, video.duration - this.playableTime_.min));
    };
