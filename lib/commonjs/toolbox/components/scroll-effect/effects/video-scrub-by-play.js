...
exports.VideoScrubByPlay = void 0;
...
var VideoScrubByPlay = (function () {
    function VideoScrubByPlay(getForwardsVideoFunction, getBackwardsVideoFunction, _a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.playableTime, playableTime = _c === void 0 ? new numeric_range_1.NumericRange(Number.NEGATIVE_INFINITY, Number.POSITIVE_INFINITY) : _c, _d = _b.activePercentages, activePercentages = _d === void 0 ? new numeric_range_1.NumericRange(0, 1) : _d;
    ...
    VideoScrubByPlay.getTargetTime_ = function (video, percentage, playableTime) {
        var actualRange = playableTime.getOverlap(new numeric_range_1.NumericRange(0, video.duration));
    ...
    VideoScrubByPlay.prototype.getReversePlayableTime_ = function (video) {
        return new numeric_range_1.NumericRange(Math.max(0, video.duration - this.playableTime_.getMax()), Math.min(video.duration, video.duration - this.playableTime_.getMin()));
    };
