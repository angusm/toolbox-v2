...
var MeteredProgressiveDisclosure = (function () {
    ...
    MeteredProgressiveDisclosure.prototype.init_ = function () {
        ...
        targetsWithNext.forEach(function (_a) {
            ...
            event_handler_1.eventHandler.addListener(target, _this.getSeenForDurationClass_(), function () { return add_class_if_missing_1.addClassIfMissing(next, _this.getActiveCSSClass_()); });
        });
    };
