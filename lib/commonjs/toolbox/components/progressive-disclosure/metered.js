...
var MeteredProgressiveDisclosure = (function () {
    ...
    MeteredProgressiveDisclosure.prototype.setupSequence_ = function (targetsWithNext) {
        ...
        event_handler_1.eventHandler.addListener(target, this.getSeenForDurationClass_(), function () {
            event_handler_1.eventHandler.addListener(target, is_bottom_visible_1.IsBottomVisible, function () {
