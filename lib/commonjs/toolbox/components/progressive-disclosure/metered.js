    ...
    MeteredProgressiveDisclosure.prototype.setupSequence_ = function (targetsWithNext, transitionTime) {
        ...
        setTimeout(function () {
            var seenBottomListener = event_handler_1.eventHandler.addListener(target, is_bottom_visible_1.IsBottomVisible, function () {
                ...
                add_class_if_missing_1.addClassIfMissing(target, _this.getTimerStartedCSSClass_());
            });
            var seenForDurationListener = event_handler_1.eventHandler.addListener(target, _this.getSeenForDurationClass_(), function () {
                ...
                add_class_if_missing_1.addClassIfMissing(target, _this.getTimerEndedCSSClass_());
                remove_class_if_present_1.removeClassIfPresent(target, _this.getTimerStartedCSSClass_());
