...
var HighContrastProperty = (function () {
    ...
    HighContrastProperty.prototype.render_ = function () {
        ...
        render_loop_1.renderLoop.measure(function () {
            render_loop_1.renderLoop.cleanup(function () { return _this.render_(); });
            var bgElement = get_element_behind_1.getElementBehind(_this.target_, _this.candidateBgElements_);
            var textColorToSet = _this.getTextColorToSet_(bgElement);
            render_loop_1.renderLoop.mutate(function () { return set_style_1.setStyle(_this.target_, _this.constructor.getProperty(), textColorToSet.toStyleString()); });
        });
    };
