...
exports.Physical2d = exports.defaultPhysical2dConfig = void 0;
...
var Physical2d = (function () {
    ...
    Physical2d.getBreakFactor = function (breakForce, milliseconds) {
        var raisedBreakforce = Math.pow(breakForce, milliseconds);
    ...
    Physical2d.prototype.predictStateInXMilliseconds = function (milliseconds) {
        ...
        var breakFactor = Physical2d.getBreakFactor(this.breakForce_, milliseconds);
