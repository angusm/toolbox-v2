...
var Physical2d = (function () {
    ...
    Physical2d.prototype.predictStateInXMilliseconds = function (milliseconds) {
        ...
        var velocity = base_1.Constraint2d.applyConstraints.apply(base_1.Constraint2d, [this.velocity_.scale(Math.pow(this.breakForce_, milliseconds))
                .add(scaledAccelPerMs)].concat(this.constraints_));
        var distance = base_1.Constraint2d.applyConstraints.apply(base_1.Constraint2d, [this.velocity_.add(this.acceleration_).scale(breakFactor / 1000)].concat(this.constraints_));
