    ...
    Physical2D.prototype.render_ = function () {
        ...
        render_loop_1.renderLoop.measure(function () {
            ...
            event_handler_1.eventHandler
                .dispatchEvent(new move_event_1.Move(_this, _this.element_, velocityToApply));
            render_loop_1.renderLoop.mutate(function () { return updatedPosition.positionElementByTranslation(_this.element_); });
        });
    };
    return Physical2D;
}());
