...
var Physical2D = (function () {
    ...
    Physical2D.prototype.render_ = function () {
        ...
        render_loop_1.renderLoop.measure(function () {
            ...
            _this.velocity_ =
                _this.velocity_
                    .add(_this.acceleration_)
                    .toNthPower(_this.accelerationExponent_)
                    .clampLength(_this.maxVelocity_);
            if (_this.velocity_.getLength() < 1) {
                _this.velocity_ = new vector_2d_1.Vector2d(0, 0);
            }
            event_handler_1.eventHandler.dispatchEvent(new move_event_1.Move(_this, _this.element_, _this.velocity_));
            var newPosition = position.add(_this.velocity_);
            var constrainedPosition = base_1.Constraint2d.applyConstraints.apply(base_1.Constraint2d, [newPosition].concat(_this.constraints_));
            render_loop_1.renderLoop.mutate(function () { return constrainedPosition.positionElementByTranslation(_this.element_); });
        });
    };
    return Physical2D;
}());
