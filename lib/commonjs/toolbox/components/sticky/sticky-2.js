...
var computed_style_service_1 = require("../../utils/dom/style/computed-style-service");
...
var Sticky2 = (function () {
    ...
    Sticky2.prototype.getMeasureValue_ = function () {
        ...
        var cloneStyle = computedStyleService.getComputedStyle(this.clone_);
