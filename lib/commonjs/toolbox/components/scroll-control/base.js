...
var ScrollControl = (function () {
    function ScrollControl(control, frame, _a) {
        ...
        this.distanceRange_ = new numeric_range_1.NumericRange(startDistance, endDistance);
    ...
    ScrollControl.prototype.getFrameRange_ = function () {
        ...
        return this.distanceRange_.getOverlap(new numeric_range_1.NumericRange(-range, range));
    };
