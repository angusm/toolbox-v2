    ...
    Slide.endInteraction_ = function (carousel) {
        ...
        if (Math.abs(gestureDistance) < GESTURE_MOVEMENT_THRESHOLD) {
            ...
            var candidateSlides = carousel.getSlides()
                ...
                return get_sign_1.getSign(distance.x) === get_sign_1.getSign(gestureDistance);
            });
            carousel.transitionToSlide(get_closest_to_center_1.getClosestToCenter(candidateSlides, carousel.getContainer()));
        }
    };
