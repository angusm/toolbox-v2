...
var PhysicalSlide = (function () {
    ...
    PhysicalSlide.prototype.adjustSlideForLoop_ = function (carousel, slide) {
        ...
        if (isOffscreen) {
            ...
            var translatedDistanceFromCenter = (scroll_element_1.SCROLL_ELEMENT.clientHeight * distanceFromCenterSign) +
    ...
    PhysicalSlide.prototype.adjustSplit_ = function (carousel, target, dragAdjustment) {
        ...
        var distanceOnRightToCover = Math.min(scroll_element_1.SCROLL_ELEMENT.clientWidth, scroll_element_1.SCROLL_ELEMENT.clientWidth - slideRightEdgeDistanceFromWindowLeftEdge);
