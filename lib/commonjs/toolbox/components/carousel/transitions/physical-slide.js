...
var DEFAULT_CONSTRAINT = new fixed_y_2.DraggableFixedYConstraint();
var FIXED_Y_CONSTRAINT = new fixed_y_1.FixedYConstraint();
...
var PhysicalSlide = (function () {
    function PhysicalSlide(_a) {
        ...
        var finalPhysical2d = physical2d === null ?
            new physical_2d_1.Physical2d({ constraints: [FIXED_Y_CONSTRAINT] }) :
            physical2d;
    ...
    PhysicalSlide.prototype.getDistanceToCenter_ = function (target, carousel) {
        ...
        var nextAppliedVelocity = this.draggableBySlide_.get(target)
    ...
    PhysicalSlide.prototype.transitionToTarget_ = function (carousel) {
        ...
        var remainingTime = target.getTargetTime() - performance.now();
        ...
        var breakFactor = physical_2d_1.Physical2d.getBreakFactor(breakForce, remainingTime);
        var adjustedVelocity = distanceToCenter / (breakFactor / 1000);
    ...
    PhysicalSlide.prototype.adjustSplit_ = function (carousel, target, dragAdjustment) {
        ...
        var distanceOnRightToCover = carousel.allowsLooping() ?
            Math.min(scroll_element_1.SCROLL_ELEMENT.clientWidth, scroll_element_1.SCROLL_ELEMENT.clientWidth - slideRightEdgeDistanceFromWindowLeftEdge) :
    ...
    PhysicalSlide.prototype.getTargetSplitOffset_ = function (carousel, targetSlide, slide, direction) {
        ...
        var inBetweenSlides = this.getInBetweenSlides_(carousel, targetSlide, slide, direction);
    ...
    PhysicalSlide.prototype.getInBetweenSlides_ = function (carousel, targetSlide, slide, direction) {
    ...
    PhysicalSlide.prototype.endInteraction_ = function (event, carousel) {
        ...
        var distance = this.getDistanceToCenter_(activeSlide, carousel);
    ...
    PhysicalSlide.prototype.transition = function (target, carousel, optTransitionTime) {
        ...
        var transitionTarget = new TransitionTarget(target, performance.now() + transitionTime);
