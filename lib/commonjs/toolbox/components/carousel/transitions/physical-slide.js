...
var PhysicalSlide = (function () {
    function PhysicalSlide(_a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.acceleration, acceleration = _c === void 0 ? 1 : _c, _d = _b.deceleration, deceleration = _d === void 0 ? .5 : _d, _e = _b.maxVelocity, maxVelocity = _e === void 0 ? 10 : _e, _f = _b.breakExponent, breakExponent = _f === void 0 ? .9 : _f, _g = _b.accelerationExponent, accelerationExponent = _g === void 0 ? 1 : _g;
    ...
    PhysicalSlide.initDraggableSlides_ = function (carousel) {
        carousel.getSlides()
            ...
            var draggable = new physical_1.PhysicallyDraggable(slide, { physicalConstraints: [new fixed_y_1.FixedYConstraint()] });
