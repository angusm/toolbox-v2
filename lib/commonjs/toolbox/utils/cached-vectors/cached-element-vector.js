...
var CachedElementVector = (function () {
    ...
    CachedElementVector.prototype.destroy = function (use) {
        ...
        for_each_1.forEach(caches.values(), function (submap) {
            filter_1.filter(submap.keys(), function (submapKey) { return submap.get(submapKey) === _this; })
                .forEach(function (submapKey) { return submap.delete(submapKey); });
        });
    };
