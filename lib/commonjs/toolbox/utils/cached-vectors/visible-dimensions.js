...
exports.VisibleDimensions = void 0;
...
var VisibleDimensions = (function (_super) {
    ...
    VisibleDimensions.getForElement = function (use, args) {
        if (args === void 0) { args = [null]; }
        return dimensions_1.Dimensions.getForElement(use, args);
    };
    VisibleDimensions.getSingleton = function (use) {
        return dimensions_1.Dimensions.getSingleton(use);
    };
