...
var window_dimensions_1 = require("../cached-vectors/window-dimensions");
var ElementMask = (function () {
    function ElementMask(fixedElement, maskElement, buffer) {
        ...
        this.maskDimensions_ = dimensions_1.Dimensions.getForElement(this, [maskElement]);
        this.maskVisibleDimensions_ =
            visible_dimensions_1.VisibleDimensions.getForElement(this, [maskElement]);
        this.maskPosition_ = visible_distance_1.VisibleDistance.getForElement(this, [maskElement]);
        this.stopped_ = false;
        this.buffer_ = buffer;
        this.windowDimensions_ = window_dimensions_1.WindowDimensions.getSingleton(this);
