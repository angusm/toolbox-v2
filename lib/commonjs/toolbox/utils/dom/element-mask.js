...
var ElementMask = (function () {
    function ElementMask(fixedElement, maskElement, buffer) {
        ...
        this.maskVisibleDimensions_ =
            visible_dimensions_1.VisibleDimensions.getForElement(maskElement);
        this.maskPosition_ =
            visible_distance_1.VisibleDistance.getForElement(maskElement);
        this.stopped_ = false;
        this.buffer_ = buffer;
        this.init_();
    }
    ...
    ElementMask.prototype.renderFixed_ = function () {
        var _this = this;
        var _a = this.getWindowDimensionRanges_(), widthRange = _a[0], heightRange = _a[1];
        ...
        if (this.maskVisibleDimensions_.getDimensions().getLength() != 0) {
            bufferedDimensions = (_b = this.maskVisibleDimensions_.getDimensions()
                .add(new dimensions_2d_1.Dimensions2d(this.buffer_, this.buffer_))).clamp.apply(_b, this.maskDimensions_.getDimensions().asRanges());
        }
        render_loop_1.renderLoop.mutate(function () {
