...
var Translate = (function (_super) {
    ...
    function Translate() {
        ...
        var _this = this;
        var values = rawValues.length === calcValueLength ? rawValues.concat(generate_filled_array_1.generateFilledArray(calcValueLength, function () { return 0; })) :
            rawValues;
    ...
    Translate.fromStyleString = function (value) {
        return new (Translate.bind.apply(Translate, [void 0].concat(flatten_1.flatten(transform_value_base_1.TransformValueBase.styleStringToValues(value)
    ...
    Translate.getDefaultValue = function () {
        return new (Translate.bind.apply(Translate, [void 0].concat(generate_filled_array_1.generateFilledArray(Translate.valuesLength, function () { return 0; }))))();
    };
