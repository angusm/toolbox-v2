...
var SkewX = (function (_super) {
    ...
    SkewX.fromStyleString = function (value) {
        return new (SkewX.bind.apply(SkewX, [void 0].concat(flatten_1.flatten(transform_value_base_1.TransformValueBase.styleStringToValues(value)
    ...
    SkewX.getDefaultValue = function () {
        return new (SkewX.bind.apply(SkewX, [void 0].concat(generate_filled_array_1.generateFilledArray(SkewX.valuesLength, function () { return 0; }))))();
    };
