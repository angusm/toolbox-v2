...
var Skew = (function (_super) {
    ...
    Skew.fromStyleString = function (value) {
        return new (Skew.bind.apply(Skew, __spreadArrays([void 0], transform_value_base_1.TransformValueBase.styleStringToPlainNumbers(value))))();
    };
    ...
    Skew.getDefaultValue = function () {
        return new (Skew.bind.apply(Skew, __spreadArrays([void 0], generate_filled_array_1.generateFilledArray(Skew.valuesLength, function () { return 0; }))))();
    };
