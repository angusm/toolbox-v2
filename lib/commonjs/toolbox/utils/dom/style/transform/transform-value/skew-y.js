...
var SkewY = (function (_super) {
    ...
    SkewY.fromStyleString = function (value) {
        return new (SkewY.bind.apply(SkewY, __spreadArrays([void 0], flatten_1.flatten(transform_value_base_1.TransformValueBase.styleStringToValues(value)
    ...
    SkewY.getDefaultValue = function () {
        return new (SkewY.bind.apply(SkewY, __spreadArrays([void 0], generate_filled_array_1.generateFilledArray(SkewY.valuesLength, function () { return 0; }))))();
    };
