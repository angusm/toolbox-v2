...
var RotateY = (function (_super) {
    ...
    RotateY.fromNumbers = function () {
        ...
        return new (RotateY.bind.apply(RotateY, __spreadArrays([void 0], values)))();
    };
    RotateY.fromStyleString = function (value) {
        return new (RotateY.bind.apply(RotateY, __spreadArrays([void 0], flatten_1.flatten(transform_value_base_1.TransformValueBase.styleStringToValues(value)
    ...
    RotateY.getDefaultValue = function () {
        return new (RotateY.bind.apply(RotateY, __spreadArrays([void 0], generate_filled_array_1.generateFilledArray(RotateY.valuesLength, function () { return 0; }))))();
    };
