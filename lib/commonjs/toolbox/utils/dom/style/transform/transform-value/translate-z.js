...
var TranslateZ = (function (_super) {
    ...
    TranslateZ.fromStyleString = function (value) {
        return new (TranslateZ.bind.apply(TranslateZ, __spreadArrays([void 0], css_calc_formula_1.CssCalcFormula
    ...
    TranslateZ.getDefaultValue = function () {
        return new (TranslateZ.bind.apply(TranslateZ, __spreadArrays([void 0], generate_filled_array_1.generateFilledArray(TranslateZ.valuesLength, function () { return 0; }))))();
    };
