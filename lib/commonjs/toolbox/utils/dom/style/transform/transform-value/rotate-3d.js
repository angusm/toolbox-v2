...
var Rotate3d = (function (_super) {
    ...
    Rotate3d.fromNumbers = function () {
        ...
        return new (Rotate3d.bind.apply(Rotate3d, __spreadArrays([void 0], values)))();
    };
    Rotate3d.fromStyleString = function (value) {
        return new (Rotate3d.bind.apply(Rotate3d, __spreadArrays([void 0], flatten_1.flatten(transform_value_base_1.TransformValueBase.styleStringToValues(value)
    ...
    Rotate3d.getDefaultValue = function () {
        return new (Rotate3d.bind.apply(Rotate3d, __spreadArrays([void 0], generate_filled_array_1.generateFilledArray(Rotate3d.valuesLength, function () { return 0; }))))();
    };
