...
var Rotate = (function (_super) {
    ...
    Rotate.fromStyleString = function (value) {
        return new (Rotate.bind.apply(Rotate, __spreadArrays([void 0], flatten_1.flatten(transform_value_base_1.TransformValueBase.styleStringToValues(value)
    ...
    Rotate.getDefaultValue = function () {
        return new (Rotate.bind.apply(Rotate, __spreadArrays([void 0], generate_filled_array_1.generateFilledArray(Rotate.valuesLength, function () { return 0; }))))();
    };
