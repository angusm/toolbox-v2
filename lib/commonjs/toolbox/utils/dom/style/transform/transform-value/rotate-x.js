...
var RotateX = (function (_super) {
    ...
    RotateX.fromNumbers = function () {
        ...
        return new (RotateX.bind.apply(RotateX, __spreadArrays([void 0], values)))();
    };
    RotateX.fromStyleString = function (value) {
        return new (RotateX.bind.apply(RotateX, __spreadArrays([void 0], flatten_1.flatten(transform_value_base_1.TransformValueBase.styleStringToValues(value)
    ...
    RotateX.getDefaultValue = function () {
        return new (RotateX.bind.apply(RotateX, __spreadArrays([void 0], generate_filled_array_1.generateFilledArray(RotateX.valuesLength, function () { return 0; }))))();
    };
