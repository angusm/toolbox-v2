...
var TranslateX = (function (_super) {
    ...
    TranslateX.fromStyleString = function (value) {
        return new (TranslateX.bind.apply(TranslateX, [void 0].concat(css_calc_formula_1.CssCalcFormula
    ...
    TranslateX.getDefaultValue = function () {
        return new (TranslateX.bind.apply(TranslateX, [void 0].concat(generate_filled_array_1.generateFilledArray(TranslateX.valuesLength, function () { return 0; }))))();
    };
