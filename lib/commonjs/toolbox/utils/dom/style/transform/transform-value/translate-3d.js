...
var Translate3d = (function (_super) {
    ...
    Translate3d.fromStyleString = function (value) {
        return new (Translate3d.bind.apply(Translate3d, [void 0].concat(flatten_1.flatten(transform_value_base_1.TransformValueBase.styleStringToValues(value)
    ...
    Translate3d.getDefaultValue = function () {
        return new (Translate3d.bind.apply(Translate3d, [void 0].concat(generate_filled_array_1.generateFilledArray(Translate3d.valuesLength, function () { return 0; }))))();
    };
