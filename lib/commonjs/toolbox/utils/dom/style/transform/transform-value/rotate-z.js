...
var RotateZ = (function (_super) {
    ...
    RotateZ.fromStyleString = function (value) {
        return new (RotateZ.bind.apply(RotateZ, [void 0].concat(flatten_1.flatten(transform_value_base_1.TransformValueBase.styleStringToValues(value)
    ...
    RotateZ.getDefaultValue = function () {
        return new (RotateZ.bind.apply(RotateZ, [void 0].concat(generate_filled_array_1.generateFilledArray(RotateZ.valuesLength, function () { return 0; }))))();
    };
