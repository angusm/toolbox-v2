...
var TranslateY = (function (_super) {
    ...
    TranslateY.fromStyleString = function (value) {
        return new (TranslateY.bind.apply(TranslateY, [void 0].concat(css_calc_formula_1.CssCalcFormula
    ...
    TranslateY.getDefaultValue = function () {
        return new (TranslateY.bind.apply(TranslateY, [void 0].concat(generate_filled_array_1.generateFilledArray(TranslateY.valuesLength, function () { return 0; }))))();
    };
