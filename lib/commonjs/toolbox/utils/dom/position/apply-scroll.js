...
function applyScroll(vector, _a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.target, target = _c === void 0 ? scroll_element_1.SCROLL_ELEMENT : _c, _d = _b.applyImmediately, applyImmediately = _d === void 0 ? false : _d;
    if (target === scroll_element_1.SCROLL_ELEMENT) {
        apply_scroll_to_scroll_element_1.applyScrollToScrollElement(vector, { applyImmediately: applyImmediately });
        return;
    }
    ...
    if (!setToRun) {
        ...
        if (applyImmediately) {
            ...
            render_loop_1.renderLoop.anyMutate(applyScrollMutate_);
        }
    }
}
