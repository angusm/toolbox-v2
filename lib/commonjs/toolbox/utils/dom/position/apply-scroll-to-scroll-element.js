...
exports.applyScrollToScrollElement = void 0;
...
function applyScrollToScrollElement(vector, _a) {
    ...
    var scrollSingleton = scroll_1.Scroll.getSingleton(scrollSingletonSymbol);
    var apply = function () {
        set_scroll_1.setScroll(scrollSingleton.getPosition().add(scrollToApply));
