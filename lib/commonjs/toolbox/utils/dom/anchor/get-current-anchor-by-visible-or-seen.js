...
var is_visible_2 = require("../style/is-visible");
...
function getCurrentAnchorByVisibleOrSeen_(getAnchorsFn) {
    ...
    var eligibleAnchors = getAnchorsFn()
        .filter(function (anchor) { return is_visible_1.isVisible(anchor) || is_scrolled_past_1.isScrolledPast(anchor); })
        .filter(function (anchor) { return is_visible_2.isVisible(anchor) && is_displayed_1.isDisplayed(anchor); })
