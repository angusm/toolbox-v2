...
var UserAgent = (function () {
    ...
    UserAgent.getBrowser = function () {
        var matchingBrowser = browsers.find(function (browser) { return browser.isCurrentBrowser(); });
        if (is_defined_1.isDefined(matchingBrowser)) {
            return matchingBrowser;
        }
        else {
            return unknown_1.UnknownBrowser;
        }
    };
    UserAgent.isMobile = function () {
        return /Mobile|mini|Fennec|Android|iP(ad|od|hone)/.test(string_1.USER_AGENT_STRING);
    };
    ...
    UserAgent.getOS = function () {
        ...
        if (is_defined_1.isDefined(matchingOs)) {
            return matchingOs;
        }
        else {
            return unknown_2.UnknownOS;
        }
    };
    return UserAgent;
}());
