...
var Browser = (function () {
    ...
    Browser.getSupportedStyleValueToGenericMap_ = function () {
        if (!this.supportedStyleValueToGeneric_) {
            this.supportedStyleValueToGeneric_ =
                new multi_value_1.MultiValueMap(__spreadArrays(map_1.map(this.genericStyleValueToSupported_.entries(), function (_a) {
    ...
    Browser.genericStyleValueToSupported_ = new multi_value_1.MultiValueMap();
    return Browser;
}());
