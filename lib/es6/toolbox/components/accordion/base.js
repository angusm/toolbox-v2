...
var AccordionItem = (function () {
    ...
    AccordionItem.prototype.hide = function () {
        var _this = this;
        renderLoop.mutate(function () { return _this.changeVisibility_(AccordionItem.hideElement_); });
    };
    AccordionItem.prototype.show = function () {
        var _this = this;
        renderLoop.mutate(function () { return _this.changeVisibility_(AccordionItem.showElement_); });
    };
    ...
    AccordionItem.prototype.changeVisibility_ = function (visibilityChangeFn) {
        var zippedElementsAndSelectors = zip(this.getElements_(), this.getSelectors_());
