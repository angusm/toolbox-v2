...
var Draggable = (function () {
    ...
    Draggable.prototype.initInteraction_ = function () {
        ...
        addDomEventListener(window, EventType.CURSOR_UP, function () { return _this.endInteraction_(); });
        addDomEventListener(window, EventType.DRAGSTART, function () { return _this.endInteraction_(); });
        addDomEventListener(window, EventType.MOUSEOUT, function () { return _this.endInteraction_(); });
    };
    ...
    Draggable.prototype.getDelta_ = function () {
        var _this = this;
        return this.constraints_.reduce(function (delta, constraint) { return constraint.constrainDelta(_this, delta); }, cursor.getClient().getPressedFrameDelta());
    };
