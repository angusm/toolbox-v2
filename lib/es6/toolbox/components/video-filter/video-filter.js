...
var VideoFilter = (function () {
    ...
    VideoFilter.prototype.render_ = function () {
        ...
        window.requestAnimationFrame(function () {
            var videoSize = Dimensions2d.fromVideo(_this.video_).scale(_this.scale_);
            var primaryCanvasSize = Dimensions2d.fromCanvas(_this.primaryCanvas_);
            var backingCanvasSize = Dimensions2d.fromCanvas(_this.backingCanvas_);
