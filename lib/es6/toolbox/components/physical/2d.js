...
var Physical2D = (function () {
    ...
    Physical2D.prototype.render_ = function () {
        ...
        renderLoop.measure(function () {
            ...
            eventHandler.dispatchEvent(new Move(_this, _this.element_, _this.velocity_));
            var newPosition = position.add(_this.velocity_);
            var constrainedPosition = Constraint2d.applyConstraints.apply(Constraint2d, [newPosition].concat(_this.constraints_));
            renderLoop.mutate(function () { return constrainedPosition.positionElementByTranslation(_this.element_); });
        });
    };
    return Physical2D;
}());
