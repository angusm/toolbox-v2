...
var MeteredProgressiveDisclosure = (function () {
    ...
    MeteredProgressiveDisclosure.prototype.setupSequence_ = function (targetsWithNext) {
        ...
        var seenForDurationListener = eventHandler.addListener(target, this.getSeenForDurationClass_(), function () {
            eventHandler.removeListener(seenForDurationListener);
            var isBottomVisibleListener = eventHandler.addListener(target, IsBottomVisible, function () {
