...
var PhysicalSlide = (function () {
    ...
    PhysicalSlide.prototype.adjustSlideForLoop_ = function (carousel, slide) {
        ...
        if (isOffscreen) {
            ...
            var translatedDistanceFromCenter = (SCROLL_ELEMENT.clientHeight * distanceFromCenterSign) +
    ...
    PhysicalSlide.prototype.adjustSplit_ = function (carousel, target, dragAdjustment) {
        ...
        var distanceOnRightToCover = Math.min(SCROLL_ELEMENT.clientWidth, SCROLL_ELEMENT.clientWidth - slideRightEdgeDistanceFromWindowLeftEdge);
