...
var FIXED_Y_CONSTRAINT = new FixedYConstraint();
...
var PhysicalSlide = (function () {
    ...
    PhysicalSlide.prototype.initDraggableSlides_ = function (carousel) {
        ...
        carousel.getSlides()
            ...
            eventHandler.addListener(draggable, Drag, function (event) { return _this.adjustSplit_(carousel, event.getElement()); });
    ...
    PhysicalSlide.prototype.transitionToTarget_ = function (carousel) {
        ...
        var breakFactor = Physical2d.getBreakFactor(breakForce, remainingTime);
