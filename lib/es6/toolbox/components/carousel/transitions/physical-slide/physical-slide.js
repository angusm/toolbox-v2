...
var PhysicalSlide = (function () {
    function PhysicalSlide(_a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.transitionTime, transitionTime = _c === void 0 ? 500 : _c, _d = _b.easingFunction, easingFunction = _d === void 0 ? EasingFunction.EASES_IN_OUT_SINE : _d;
        this.draggableBySlide_ =
            DynamicDefaultMap.usingFunction(function (carousel) { return new SlideToDraggableMap(carousel); });
    ...
    PhysicalSlide.prototype.endInteraction_ = function (event, carousel) {
        ...
        var velocity = interactionDuration > 700 ?
            0 :
            Vector2d.fromElementTransform(event.getTarget().getElement()).getX() -
                this.interactionStartX_;
