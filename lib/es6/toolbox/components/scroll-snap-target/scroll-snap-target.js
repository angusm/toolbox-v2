...
var Coordinator = (function () {
    ...
    Coordinator.prototype.add = function (target) {
        ...
        getOffsetAncestors(target.getElement().parentElement).forEach(function (ancestor) {
...
var ScrollSnapTarget = (function () {
    ...
    ScrollSnapTarget.prototype.handleResize_ = function () {
        ...
        this.rfIds_.add(renderLoop.anyMutate(function () { return setStyle(_this.element_, 'scroll-snap-align', snapAlignValue); }));
    };
    ...
    ScrollSnapTarget.prototype.destroy = function () {
        ...
        forEach(this.rfIds_.values(), function (rfId) { return renderLoop.clear(rfId); });
        renderLoop.anyMutate(function () { return setStyle(_this.element_, 'scroll-snap-align', ScrollSnapAlign.NONE); });
    };
