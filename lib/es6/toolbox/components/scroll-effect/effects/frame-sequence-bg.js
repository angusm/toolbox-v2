...
var FrameSequenceBg = (function () {
        ...
        return loadImage(frameUrl)
            ...
            _this.targetStates_.forEach(function (targetState, target) {
                ...
                if (desiredFrame === frameToLoad) {
                    ...
                    var mustUpdate = FrameSequenceBg
    ...
    FrameSequenceBg.requiresUpdateForNewFrame_ = function (newFrame, targetState) {
    ...
    FrameSequenceBg.prototype.setFrameOpacity_ = function (frame, opacity) {
        var _this = this;
