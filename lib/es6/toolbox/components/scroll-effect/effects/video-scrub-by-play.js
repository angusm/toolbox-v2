...
var VideoScrubByPlay = (function () {
    function VideoScrubByPlay(getForwardsVideoFunction, getBackwardsVideoFunction, _a) {
        var _b = _a === void 0 ? {} : _a, _c = _b.playableTime, playableTime = _c === void 0 ? new Range(Number.NEGATIVE_INFINITY, Number.POSITIVE_INFINITY) : _c, _d = _b.activePercentages, activePercentages = _d === void 0 ? new Range(0, 1) : _d;
