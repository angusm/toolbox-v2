...
var Browser = (function () {
    ...
    Browser.isCurrentBrowser = function () {
        return this.getUaids_().some(function (uaid) { return contains(USER_AGENT_STRING, uaid); });
    };
    Browser.getVersion = function () {
        ...
        var offset = offsets
            .find(function (offset) { return contains(USER_AGENT_STRING, offset[0]); });
        var range = [USER_AGENT_STRING.indexOf(offset[0]), offset[1]];
