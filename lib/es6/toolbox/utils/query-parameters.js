...
var QueryParameters = (function () {
    ...
    QueryParameters.updateUrl = function (queryParams, reload) {
        ...
        var pathWithHash = "" + window.location.pathname + window.location.hash;
        if (!reload) {
            window.history.pushState({ 'path': "" + window.location.origin + pathWithHash }, '', "" + pathWithHash + paramsString);
        }
        else {
