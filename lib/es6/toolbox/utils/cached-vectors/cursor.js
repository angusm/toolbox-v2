...
var CursorData = (function () {
    ...
    CursorData.prototype.getPressedGestureVelocity = function () {
        ...
        var gestureTimeInMilliseconds = positions.slice(-1)[0].getTime().valueOf() -
    ...
    CursorData.prototype.getLastFrameVelocity = function () {
        var lastFrame = this.positions.slice(-1)[0];
        var secondLastFrame = this.positions.slice(-2)[0];
        var frameDeltaInSeconds = lastFrame.getTime().valueOf() - secondLastFrame.getTime().valueOf();
        return CursorData.getGestureDeltaFromPositions_.apply(CursorData, this.positions.slice(-2)).scale(1 / frameDeltaInSeconds);
    };
