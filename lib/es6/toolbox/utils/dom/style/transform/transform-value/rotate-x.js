...
var RotateX = (function (_super) {
    ...
    RotateX.fromStyleString = function (value) {
        return new (RotateX.bind.apply(RotateX, __spreadArrays([void 0], flatten(TransformValueBase.styleStringToValues(value)
    ...
    RotateX.getDefaultValue = function () {
        return new (RotateX.bind.apply(RotateX, __spreadArrays([void 0], generateFilledArray(RotateX.valuesLength, function () { return 0; }))))();
    };
