...
var Translate3d = (function (_super) {
    ...
    Translate3d.fromStyleString = function (value) {
        return new (Translate3d.bind.apply(Translate3d, __spreadArrays([void 0], flatten(TransformValueBase.styleStringToValues(value)
    ...
    Translate3d.getDefaultValue = function () {
        return new (Translate3d.bind.apply(Translate3d, __spreadArrays([void 0], generateFilledArray(Translate3d.valuesLength, function () { return 0; }))))();
    };
