...
var RotateY = (function (_super) {
    ...
    RotateY.fromStyleString = function (value) {
        return new (RotateY.bind.apply(RotateY, __spreadArrays([void 0], flatten(TransformValueBase.styleStringToValues(value)
    ...
    RotateY.getDefaultValue = function () {
        return new (RotateY.bind.apply(RotateY, __spreadArrays([void 0], generateFilledArray(RotateY.valuesLength, function () { return 0; }))))();
    };
