...
var Rotate3d = (function (_super) {
    ...
    Rotate3d.fromStyleString = function (value) {
        return new (Rotate3d.bind.apply(Rotate3d, __spreadArrays([void 0], flatten(TransformValueBase.styleStringToValues(value)
    ...
    Rotate3d.getDefaultValue = function () {
        return new (Rotate3d.bind.apply(Rotate3d, __spreadArrays([void 0], generateFilledArray(Rotate3d.valuesLength, function () { return 0; }))))();
    };
