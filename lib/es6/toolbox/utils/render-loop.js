...
var RenderLoop = (function () {
    function RenderLoop() {
        ...
        this.runLoopCallback_ = function (timestamp) { _this.runLoop(timestamp); };
        this.init_();
    }
    ...
    RenderLoop.prototype.setupScrollListener_ = function () {
        var _this = this;
        window.addEventListener('scroll', function () { return _this.runScrollLoop(); }, { passive: true, capture: false, once: true });
    };
