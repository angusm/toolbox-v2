...
var DestroyableRenderLoop = (function () {
    function DestroyableRenderLoop(renderLoop) {
        this.rl_ = renderLoop;
        this.ids_ = new Set();
    }
    DestroyableRenderLoop.prototype.wrapFunction_ = function (rlFunction, fn) {
        var _this = this;
        var id = rlFunction.bind(this.rl_)(function () {
            _this.ids_.delete(id);
            fn();
        });
        this.ids_.add(id);
        return id;
    };
    DestroyableRenderLoop.prototype.framecount = function (fn) {
        return this.wrapFunction_(this.rl_.framecount, fn);
    };
    DestroyableRenderLoop.prototype.premeasure = function (fn) {
        return this.wrapFunction_(this.rl_.premeasure, fn);
    };
    DestroyableRenderLoop.prototype.measure = function (fn) {
        return this.wrapFunction_(this.rl_.measure, fn);
    };
    DestroyableRenderLoop.prototype.physics = function (fn) {
        return this.wrapFunction_(this.rl_.physics, fn);
    };
    DestroyableRenderLoop.prototype.mutate = function (fn) {
        return this.wrapFunction_(this.rl_.mutate, fn);
    };
    DestroyableRenderLoop.prototype.cleanup = function (fn) {
        return this.wrapFunction_(this.rl_.cleanup, fn);
    };
    DestroyableRenderLoop.prototype.scrollPremeasure = function (fn) {
        return this.wrapFunction_(this.rl_.scrollPremeasure, fn);
    };
    DestroyableRenderLoop.prototype.scrollMeasure = function (fn) {
        return this.wrapFunction_(this.rl_.scrollMeasure, fn);
    };
    DestroyableRenderLoop.prototype.scrollMutate = function (fn) {
        return this.wrapFunction_(this.rl_.scrollMutate, fn);
    };
    DestroyableRenderLoop.prototype.scrollCleanup = function (fn) {
        return this.wrapFunction_(this.rl_.scrollCleanup, fn);
    };
    DestroyableRenderLoop.prototype.anyPremeasure = function (fn) {
        return this.wrapFunction_(this.rl_.anyPremeasure, fn);
    };
    DestroyableRenderLoop.prototype.anyMeasure = function (fn) {
        return this.wrapFunction_(this.rl_.anyMeasure, fn);
    };
    DestroyableRenderLoop.prototype.anyMutate = function (fn) {
        return this.wrapFunction_(this.rl_.anyMutate, fn);
    };
    DestroyableRenderLoop.prototype.anyCleanup = function (fn) {
        return this.wrapFunction_(this.rl_.anyCleanup, fn);
    };
    DestroyableRenderLoop.prototype.destroy = function () {
        var _this = this;
        this.ids_.forEach(function (id) { return _this.rl_.clear(id); });
        this.ids_.clear();
    };
    return DestroyableRenderLoop;
}());
var RenderLoop = (function () {
    ...
    RenderLoop.prototype.getDestroyableInstance = function () {
