/**
 * Used https://github.com/gre/bezier-easing as starting point.
 *
...
function newtonRaphsonIterate (
  aX: number, aGuessT: number, mX1: number, mX2: number
): number {
